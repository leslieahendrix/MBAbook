...
# if you got an error abuot not having SnowballC, run  install.packages("SnowballC") first
...
l <- rowSums(dtm)
reviews$text[l<10][which.max(yhat[l<10])] #modeled best review

reviews$text[l<10][which.min(yhat[l<10])] #modeled worst review
